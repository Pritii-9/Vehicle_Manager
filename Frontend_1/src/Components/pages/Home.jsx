    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (!vehicleCountResponse.ok) {
          // Handle 404 specifically if you've decided NOT to implement this endpoint
          if (vehicleCountResponse.status === 404) {
            console.warn("Endpoint /api/vehicles/count not found. Skipping.");
            setTotalVehicles(0); // Set a default value
          } else {
