        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                ...
                <button
                    ...
                    className="bg-[#5046e4] text-white font-bold py-2 px-4 rounded hover:bg-[#3a32c7] transition duration-200"
                >
                    Show Log Sheets
                </button>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md"> {/* Enclosing div with white background and shadow */}
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-6"> {/* Removed border */}
                    <div>
                        ...
                        <select
                            ...
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline hover:border-blue-500 transition duration-200"
                            id="vehicleNumber"
                        >
                        ...
                        <table className="min-w-full bg-white border border-gray-300 shadow-md rounded-lg">
                            ...
                            <tbody>
                                {logSheets.map((logSheet) => (
                                    <tr key={logSheet._id} className="hover:bg-gray-50 transition duration-100">
                                        ...
                                        <td className="py-2 px-4 border-b text-center">
                                            <div className="flex justify-center space-x-2">
                                                <button
                                                    ...
                                                    className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded text-xs transition duration-200"
                                                >
                                                    Edit
                                                </button>
                                                <button
                                                    onClick={() => handleDeleteLogSheet(logSheet._id)}
                                                    className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded text-xs transition duration-200"
                                                >
                                                    Delete
                                                </button>
                                            </div>
